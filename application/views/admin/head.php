<head>
    ...
    <link href="<?php echo base_url();?>admin-panel/css/plugins/dataTables.bootstrap.css" rel="stylesheet">
    <link href="<?php echo base_url();?>admin-panel/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>admin-panel/datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
